...
eDomoticzAccessory.prototype = {
            ...
            case this.swTypeVal == Constants.DeviceTypeMedia:
                {
                    ...
                    var brightnessCharacteristic = this.getCharacteristic(service, Characteristic.Brightness);
    ...
    getServices: function () {
        ...
        informationService.setCharacteristic(Characteristic.Manufacturer, "iBeyondSmart").setCharacteristic(Characteristic.Model, this.Type).setCharacteristic(Characteristic.SerialNumber, "Unique ID " + this.idx);
