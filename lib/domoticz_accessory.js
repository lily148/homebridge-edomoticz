            ...
            case this.swTypeVal == Constants.DeviceTypeMedia:
                {
                    ...
                    if (isOn && this.factor) {
                        var handleDimLevelChange = function (level) {
                            ...
                            if (level > 0) {
                                setTimeout(function () {
                                    this.cachedValues[isFan ? Characteristic.RotationSpeed.UUID : Characteristic.Brightness.UUID] = level;
                        ...
                        if (typeof message.svalue1 == 'undefined') {
                            this.cachedValues[isFan ? Characteristic.RotationSpeed.UUID : Characteristic.Brightness.UUID] = 0;
