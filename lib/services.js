...
// Fan Characteristics
eDomoticzServices.RotationSpeed = function() {
	var charUUID = '00000029-0000-1000-8000-0026BB765291';//UUID.generate('eDomoticz:customchar:Visibility');
  Characteristic.call(this, 'Rotation Speed', charUUID);
  this.setProps({
    format: Characteristic.Formats.FLOAT,
    unit: Characteristic.Units.PERCENTAGE,
    maxValue: 5,
